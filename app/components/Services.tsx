...
export default function Services() {
  ...
  return (
    <section className="bg-[#F8FAFC] text-[#1A202C]">
      ...
      <section id="visual" className="py-40 px-8 md:px-24 border-t border-slate-200 overflow-hidden bg-white">
        ...
        >
          <motion.div variants={fadeInUp}>
            ...
            <h2 className="text-5xl md:text-7xl font-black tracking-tighter mb-8 leading-none text-[#1A202C]">
              一瞬を、<br />
            ...
            <div className="grid grid-cols-1 gap-6 text-[#1A202C]">
              {[
          ...
          {/* スライドショー表示エリア - 角丸を以前より少しシャープにして誠実さを出す */}
          <motion.div variants={fadeInUp} className="relative aspect-video bg-slate-100 rounded-xl overflow-hidden shadow-2xl group border border-slate-200">
            ...
            <span className="absolute bottom-4 right-6 text-white/40 font-black text-6xl italic group-hover:text-white/60 transition-colors duration-700 select-none z-10">PHOTO</span>
          </motion.div>
        </motion.div>
      </section>
        ...
        >
          <div className="grid md:grid-cols-2 gap-20 items-center">
            <motion.div variants={fadeInUp} className="order-2 md:order-1 relative aspect-video bg-slate-200 rounded-xl overflow-hidden shadow-2xl group border border-slate-200">
              ...
              <span className="absolute bottom-4 left-6 text-white/40 font-black text-6xl italic group-hover:text-white/60 transition-colors duration-700 select-none z-10">WEB</span>
            </motion.div>
      ...
      {/* 03. セットプラン (トータルブランディング) - 青背景で視覚的な「締め」を作る */}
